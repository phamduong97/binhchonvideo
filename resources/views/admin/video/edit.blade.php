    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-primary">
          ...
          @endif
          <!-- form start -->
          <form role="form" action="{{Route('admin.update-video',$data->id_video)}}" method="post" enctype="multipart/form-data">
           {{ csrf_field() }} 

          <div class="card-body">
            <div class="form-group">
              <label>Tiêu đề (<span style="color: red;">*</span>)</label>
              <input type="text"  class="form-control" name="title" placeholder="Nhập tiêu đề ..." required="true" value="{{$data->title}}">
            </div>

            <div class="form-group">
              <label for="exampleFormControlTextarea1">Mô tả ngắn(<span style="color: red;">*</span>)</label>
              <textarea class="form-control" id="exampleFormControlTextarea1" name="summary" rows="3" placeholder="Nhập mô tả ngắn ..." required="true">{{$data->summary}}</textarea>
            </div>
            
            <div class="form-group">
              <label >Nội dung (<span style="color: red;">*</span>)</label>
              <textarea class="form-control" name="content" rows="5" id="editor1" required="true" >{{$data->content}}</textarea>
            </div>
            <script>
          ...
          <div class="form-group">
            ...
            <input type="text"  class="form-control" name="author" placeholder="Nhập tên tác giả..." required="true" value="{{$data->author}}">
          </div>

          <div class="form-group">
            <label >Thông tin tác giả (<span style="color: red;">*</span>)</label>
            <textarea class="form-control" name="info_author" rows="5"  required="true">{{$data->info_author}}</textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <form>
              ...
              <br>
              <video width="50%" height="auto" controls muted>
                    <source src="{{ asset('upload') }}/{{ $data['code_video'] }}" type="video/mp4">
                </video>
            </form>

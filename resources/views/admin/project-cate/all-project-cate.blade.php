          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-list"></i>  Tất cả danh mục sản phẩm(<span style="color: red;">{{$total}}</span>)</h3>
                     ...
                     <tr>
                      ...
                      <td style="text-align: center;">
                        <div class="d-flex justify-content-center">
                          <div>
                            <a class="btn btn-primary mr-2" href="{{ route('admin.edit-project-cate', $row->id) }}"><i class="fa fa-edit"></i> Sửa</a>
                          </div>
                          <div class="">
                           <a class="btn btn-danger mr-2" href="{{ route('admin.delete-project-cate', $row->id) }}"><i class="fas fa-trash-alt"></i> Xóa</a>
                         </div>
                       </div>
                     </td>
                   </tr>
